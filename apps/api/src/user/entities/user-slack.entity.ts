 ...
 */
@Entity('SQ_USER_SLACK', { comment: '관리자 Slack 계정 연동' })
@Index('UK_SQ_USER_SLACK_01', ['slackTeamId', 'slackUserId'], { unique: true })
@Index('UK_SQ_USER_SLACK_02', ['userKey'], { unique: true })
