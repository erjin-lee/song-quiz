import type { GptSongInput } from './gpt-answer.client';

export const GPT_ANSWER_SYSTEM_RULES = `너는 한국 음악 퀴즈의 정답 후보 데이터를 생성하는 역할이다.
...
export function buildGptAnswerUserMessage(songs: GptSongInput[]): string {
